...
class FPNdecoderformer_swin_triple(BaseModule):
    def __init__(
        self,
        ...
        self.decoder_c5_c4_3 = Fpndecoder(query_pos=pos_c5, kv_pos=pos_c4, mask=None)
        self.decoder_c5_c3_3 = Fpndecoder(query_pos=pos_c5, kv_pos=pos_c3, mask=None)
        self.decoder_c4_c5_3 = Fpndecoder(query_pos=pos_c4, kv_pos=pos_c5, mask=None)
        self.decoder_c3_c5_3 = Fpndecoder(query_pos=pos_c3, kv_pos=pos_c5, mask=None)
    ...
    def forward(self, inputs: Tuple[Tensor]) -> tuple:
        ...
        outs[0] = self.decoder_c3_c5_3(outs[0], outs[2])
        outs[1] = self.decoder_c4_c5_3(outs[1], outs[2])
        outs[2] = self.decoder_c5_c4_3(outs[2], outs[1])
        outs[2] = self.decoder_c5_c3_3(outs[2], outs[0])
