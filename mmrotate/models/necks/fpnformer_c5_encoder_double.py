...
class FPNdecoderformerc5_encoder_double(BaseModule):
    ...
    def __init__(
        ...
        self.encoder1_2 = TransformerEncoderLayer(256, nhead=8)
        self.encoder2_2 = TransformerEncoderLayer(256, nhead=8)
    ...
    def forward(self, inputs: Tuple[Tensor]) -> tuple:
        ...
        outs[2] = self.encoder1_2(outs[2], pos = pos_c5)
        outs[2] = self.encoder2_2(outs[2], pos = pos_c5)
