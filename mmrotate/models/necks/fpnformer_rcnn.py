...
class FPNdecoderformer_rcnn(BaseModule):
    def __init__(
        self,
    ...
    def forward(self, inputs: Tuple[Tensor]) -> tuple:
        ...
        outs[1] = self.decoder_c3_c5(outs[1], outs[3])
        outs[2] = self.decoder_c4_c5(outs[2], outs[3])
        outs[3] = self.decoder_c5_c4(outs[3], outs[2])
        outs[3] = self.decoder_c5_c3(outs[3], outs[1])
        # outs[1] = self.decoder_c3_c5_2(outs[1], outs[3])
        # outs[2] = self.decoder_c4_c5_2(outs[2], outs[3])
        # outs[3] = self.decoder_c5_c4_2(outs[3], outs[2])
        # outs[3] = self.decoder_c5_c3_2(outs[3], outs[1])
        outs[1], outs[2], outs[3] = outs[1].contiguous(), outs[2].contiguous(), outs[3].contiguous()
