...
data_root = '/home/guoshibo/mmrotate/rotate_image/'
backend_args = None
train_pipeline = [
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix='./work_dirs/retinanet_baseline_train_test/Task1')
...
default_hooks = dict(
    ...
    visualization=dict(
        ...
        draw=True,
        test_out_dir='/home/guoshibo/mmrotate/retinanet_baseline'))
env_cfg = dict(
